...
in a proof, but that is the extent of knowledge proofs.
...
the credential validity period can be checked by comparing the current date to the expiration date.
